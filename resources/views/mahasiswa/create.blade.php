                ...
                <div class="card-body">
                    <form method="POST" action="{{url('mahasiswa')}}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="nama" type="text" name="nama" class="@error('nama') is-invalid @enderror" autofocus>
                                @error('nama')
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="prodi" type="text" name="prodi" class="@error('prodi') is-invalid @enderror" autofocus>
                                @error('prodi')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{$message}}</strong>           
                                    </span>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="semester" type="text" name="semester" class="@error('semester') is-invalid @enderror" autofocus>
                                @error('semester')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{$message}}</strong>           
                                    </span>
